    ...
    return Scaffold(
        ...
        body: ListView(
            ...
            children: <Widget>[
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Text('2021.02.22',
                            ...
                            style: TextStyle(
                                color: Color(0xff36AE57), fontSize: 16))
                      ]),
                ),
              ),
              //SizedBox(height:20),
                  ...
                  child: Row(
                      ...
                      children: [
                        Column(children: [
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.only(top: 1.0, left: 16.0),
                            child: Container(
                              width: 231,
                              height: 7,
                              decoration: new BoxDecoration(
                          ...
                          Padding(
                            ...
                            child: Text(
                                ...
                                style: TextStyle(
                                    color: Color(0xff31AC53), fontSize: 12)),
                          ),
                        ]),
                        SizedBox(width: 10),
                        Container(
              ...
              Padding(
                padding:
                    const EdgeInsets.only(left: 12.0, top: 30.0, bottom: 11.0),
                child: GradientText1(
                  'NEWS Highlights',
                  gradient: LinearGradient(colors: [
                    Color(0xff229DE2),
